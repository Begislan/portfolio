...
from .views import admin_core, admin_portfolio_detail, portfolio_create_view, portfolio_update_view, portfolio_delete_view, profile, update_profile, CustomPasswordChangeView
