...
#                 img = img.resize((new_width, new_height), Image.LANCZOS)
    ...
    def get_absolute_url(self):
        # This should return the URL for a single portfolio item
...
def create_initial_portfolio(sender, instance, created, **kwargs):
    if created:
        Portfolio.objects.create(
            user=instance, 
            menu='О себе', 
            content='<p>Здравствуйте! Здесь вы можете написать краткое вступление о себе, ваших главных профессиональных целях и интересах.</p>', 
            active=True
        )
        Portfolio.objects.create(
            user=instance, 
            menu='Биография', 
            content='<p>Ваша подробная биография, жизненный путь и основные вехи личностного развития.</p>', 
            active=True
        )
        Portfolio.objects.create(
            user=instance, 
            menu='Образование', 
            content='<p>Список учебных заведений, которые вы окончили, полученные специальности и квалификации.</p>', 
            active=True
        )
        Portfolio.objects.create(
            user=instance, 
            menu='Опыт работы', 
            content='<p>Ваше профессиональное портфолио: места работы, занимаемые должности и ключевые достижения.</p>', 
            active=True
        )
